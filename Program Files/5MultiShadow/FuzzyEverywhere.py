    ...
    for n in range(27):
        for i in range(width):
            for j in range(height):
                pixels.append((i,j,n,random.random(),random.randint(0,7)))
...
def something(param):
    ...
    yDic[5] = [0.9,0,0.5,3.5,       0,      -1.5,   -2.5,   20,     20,     20,     20]
    yDic[6] = [.6,.55,-.1,20,       .5,     -1,     -2,     -3,     20,     20,     20]
    yDic[7] = [.3,1.1,-.8,20,       1,      -.5,    -1.5,   -2.5,   20,     20,     20]
    yDic[8] = [-.2,.85,-.45,20,     1.5,    0,      -1,     -2,     -3,     20,     20]
    yDic[9] = [-.8,0.6,0.1,20,     2,      .5,     -.5,    -1.5,   -2.5,   20,     20]
    yDic[10] = [-.35,-.15,.55,20,   2.5,    1,      0,      -1,     -2,     -3,     20]
    yDic[11] = [0.1,-0.95,1.2,20,   3,      1.5,    .5,     -.5,    -1.5,   -2.5,   20]
    yDic[12] = [.5,-.45,.85,20,     20,     2,      1,      0,      -1,     -2,     -3]
    ...
    # yDic[7] = [.6,.55,-.1,20,       .5,     -1,     -2,     -3,     -1,     -1.5,   -2]
    # yDic[8] = [.3,1.1,-.8,20,       1,      -.5,    -1.5,   -2.5,   -.5,    -1,     -1.5]
    # yDic[9] = [-.2,.85,-.45,20,     1.5,    0,      -1,     -2,     0,      -.5,    -1]
    # yDic[10] = [-.8,0.6,0.1,20,     2,      .5,     -.5,    -1.5,   .5,     0,      -.5]
    # yDic[11] = [-.35,-.15,.55,20,   2.5,    1,      0,      -1,     1,      .5,     0]
    # yDic[12] = [0.1,-0.95,1.2,20,   3,      1.5,    .5,     -.5,    1.5,    1,.5]
    # yDic[13] = [.5,-.45,.85,20,     20,     2,      1,      0,      2,1.5,1]
    # yDic[14] = [0.9,0.0,0.5,20,     20,     2.5,    1.5,    .5,     2.5,2,1.5]
    # yDic[15] = [.5,.6,-.25,20,      20,     3,      2,      1,      3,2.5,2]
    # yDic[16] = [0.1,1.2,-0.85,20,   20,     20,     2.5,    1.5,    20,3,2.5]
    # yDic[17] = [-.4,.75,-.35,20,    20,     20,     3,      2,      20,20,3]
    # yDic[18] = [-0.9,0.3,0.1,20,    20,     20,     20,     2.5,    20,20,3]
    # yDic[19] = [-.45,-.45,.65,20,   20,     20,     20,     3,      20,20,3]
    # yDic[20] = [0,-1,1.2,20,        20,     20,     20,     20,     20,20]
    ...
    s1 = Sphere(1, (0,coords[0],-3), (1.0,.5,.5))  # Center Sphere
